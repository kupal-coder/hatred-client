...
/**
 * Represents a primitive sphere used in the Bedrock protocol.
 */
@Getter
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public final class PrimitiveSphere extends PrimitiveShape {
    ...
    public PrimitiveSphere(long id, int dimension, @Nullable Vector3f position, @Nullable Float scale,
